		...
		return e.prototype.hasNext = function () {
			...
			if (typeof document != "undefined" && document !== null && this.options.mock === !1) {
				...
				if (this.options.template != null && typeof this.options.template == "string") {
					...
					for (y = 0, E = a.length; y < E; y++) s = a[y], f = document.createElement("img"), f.src = s.images[this.options.resolution].url, this.options.links === !0 ? (t = document.createElement("a"), t.href = s.link, t.appendChild(f), n.appendChild(t)) : n.appendChild(f);
